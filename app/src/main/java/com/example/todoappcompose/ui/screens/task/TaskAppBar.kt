...
import com.example.todoappcompose.component.DisplayAlertDialog
...
fun ExistingTaskAppBarPreview (){
    ExistingTaskAppBar(selectedTask = ToDoTask(id =0, title = "Yaro", description = "Test App", priority = Priority.MEDIUM),
